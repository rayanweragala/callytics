...
- Upload audio in mp3, wav, m4a, and ogg formats
- Automatic conversion for telephony playback
- Automatic conversion for browser preview
- Offline Piper text-to-speech generation
- Multiple TTS voice options
- TTS speed control
- Preview before saving
- Searchable audio library
- Reuse audio across any flow node
- Delete management for unused audio
